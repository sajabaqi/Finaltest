        ...
        public bool Insert(IFormFile FilePath)
        {
            ...
            try
            {
                ...
                using (StreamReader sr = File.OpenText(@"C:\Users\SAJA ABU-BAQI\Postman\files\emp.txt"))
                {
                    ...
                    string Header = sr.ReadLine(); //string line;
                    ...
                    {//??
                        ...
                        Random r = new Random();
                        int rinit2 = r.Next(10, 40);
                        int rint = r.Next(0, 3);
                        int rinit3 = r.Next(1000, 9999);
                        ...
                        user.Verfication_code = rinit3.ToString();
                        user.ServiceId = 1;
                        user.idrole1 = 1;
                        user.email = parts[0] + EmailDomain[rint];

                        StringBuilder stringBuilder = new StringBuilder();

                        user.Address = Countries[rinti];

                        users.Add(user); //api_UserRpoisitory.Insertuser (user);
